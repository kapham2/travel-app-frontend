...
class ExplorePlacesPeopleCard extends React.Component {
    ...
    onClickButton = (event) => {
        // console.log("ExplorePlacesPeopleCard: clicked", event.target.getAttribute("name"))
    ...
    //     // console.log("ExplorePlacesPeopleCard: deleteUserDestination => ")
    ...
    //     // console.log("ExplorePlacesPeopleCard: patchUserDestination => ")
    //     const userDestination = this.props.user_destinations.find(user_destination => user_destination.user_id === this.props.user.id && user_destination.destination_id === this.props.item.id)
    //     fetch(`http://localhost:3333/api/v1/user_destinations/${userDestination.id}`, {
    //         method: 'PATCH',
    //         headers: {
    ...
    postFollow = () => {
        // console.log("ExplorePlacesPeopleCard: postFollow => ")
    ...
    //     // console.log("ExplorePlacesPeopleCard: deleteFollow => ")
    ...
    getOtherUser = () => {
        // console.log("ExplorePlacesPeopleCard: getOtherUser => ")
...
export default connect(null, mapDispatchToProps)(ExplorePlacesPeopleCard)