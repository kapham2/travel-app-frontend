                ...
                <div className="ui very relaxed unstackable items">
                    <div className="item">
                        ...
                        <div className="content">
                            ...
                            <div className="meta">
                                <span name="Visited" onClick={this.onClickMenu}>{this.props.other_user_visited_destinations.length} cities</span> | <span name="Followers" onClick={this.onClickMenu}>{this.props.other_user_followers.length} followers</span> | <span name="Following" onClick={this.onClickMenu}>{this.props.other_user_following.length} following</span>
                            </div>
